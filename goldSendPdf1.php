...
$remarks="";
$purity="";
$query=mysqli_query($con,"SELECT * FROM trans where staDate='$date' AND metal='Gold' AND branchId='$billId' AND sta = 'Checked'");
$count=mysqli_num_rows($query);
 
 $sql="select billId, sta, date, staDate, SUM(netW) as netW,SUM(grossW) as grossW , SUM(netA) as netA,SUM(grossA) as grossA,COUNT(id) as id from trans where staDate='$date' AND metal='Gold' AND branchId='$billId' AND sta = 'Checked'";
