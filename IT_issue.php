...
if (isset($_POST['submit'])) {
	...
	$sql = mysqli_fetch_assoc(mysqli_query($con,"SELECT branchName FROM branch WHERE branchId='$branchCode'"));
	
	   if(isset($sql['branchName'])){
	$branchId = $_POST['branchId'];
	$branchName = $sql['branchName'];
	...
	if (mysqli_query($con, $insertSql)) {
		...
		echo "<script>setTimeout(\"location.href = 'IT_issue.php'\",150);</script>";
		exit;
	}
}
		...
		<div class="col-lg-12">
			<div class="hpanel">
				...
				<div class="panel-body"
					...
					<form method="POST" class="form-horizontal" action="IT_issue.php" enctype="multipart/form-data">
						<div class="col-sm-2">
							...
							<div class="input-group">
								...
								<input type="text" name="branchId" value="<?php echo $_SESSION['branchCode']; ?>"
						...
						<div class="col-sm-3">
							...
							<div class="col-sm-2">
							<label class="text-success">BM Contact No</label>
							<div class="input-group">
								<span class="input-group-addon"><span style="color:#900"
										class="fa fa-phone"></span></span>
								<input type="text" name="contact" pattern="[0-9]{10}" required placeholder="Contact Number" maxlength="10" class="form-control" autocomplete="off">
							</div>
						</div>
							<div class="col-sm-3">
				...
				<div class="panel-body"
					...
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
							<?php
							$i = 1;
							$query = mysqli_query($con, "SELECT id,branchId, issueType,contact,anydesk,date, remarks, status, rslvDate FROM it_issue WHERE  branchId='$branchCode' AND status != 'cleared' and status!='Rejected'");
