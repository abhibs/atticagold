<?php
	...
	$sql = mysqli_query($con, "SELECT b.branchName,t.* 
	FROM trare t,branch b 
	WHERE t.date='$date' AND t.branchId=b.branchId
	ORDER BY t.id ASC");
		...
		<div class="col-lg-12">
			<div class="hpanel">
				<div class="panel-heading">
					<h3><i class="fa_Icon fa fa-money"></i> Fund Transfers </h3> 
				</div>
											...
											<?php
												...
												while($k < $totalLength){
													...
													if($row['status'] == "Pending"){
														...
														echo "<td>" . $row['time'] . "</td>";
														echo "<td class='text-center'><a class='btn btn-success' href='approveRejectDeleteTfund.php?approveId=".$row['id']."' onClick=\"javascript: return confirm('Please confirm to Approve');\"><i style='color:#ffcf40' class='fa fa-check'></i> Approve</a></td>";
														echo "<td class='text-center'><a class='btn btn-success' href='approveRejectDeleteTfund.php?rejectId=".$row['id']."' onClick=\"javascript: return confirm('Please confirm to Reject');\"><i style='color:red' class='fa fa-times'></i>  Reject</a></b></td>";
														echo "</tr>";
														$i++;
													}
													$k++;
											...
											<?php
												...
												while($k < $totalLength){
													...
													if($row['status'] == "Approved"){
														...
														echo "<td>" . $row['transferAmount'] . "</td>";
														echo "<td>" . $row['time'] . "</td>";
														echo "<td class='text-center'><a class='btn btn-success' href='approveRejectDeleteTfund.php?deleteId=".$row['id']."' onClick=\"javascript: return confirm('Please confirm deletion');\"><i style='color:#ff0000' class='fa fa-times'></i> Delete</a></td>";
														echo "</tr>";
														$i++;
													}
													$k++;
