...
if (isset($_POST["submitCustomer"])) {
	$customerId = "ATTICA - " . rand(10000, 99999);
	$name = strtoupper($_REQUEST['Name']);
	$gender = $_REQUEST['Gender'];
	$dob = $_REQUEST['DOB'];
	$mobile = $_POST['mobile'];

	$caline = $_REQUEST['House'];
	$clocality = $_REQUEST['Street'];
	$cland = $_POST['cland'];
	$cstate = $_REQUEST['State'];
	$ccity = $_REQUEST['District'];
	$cpin = $_REQUEST['Pincode'];

	$IDproof = "Aadhar Card";
	$IDproofNum = $_POST['idProofNum'];
	$ADDproof = "Aadhar Card";
	$ADDproofNum = $_POST['idProofNum'];
...
if (isset($_POST["submitManualCustomer"])) {
