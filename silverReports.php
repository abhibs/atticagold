<?php
	...
	if($search=="" && $search1==""  && $search2==""){
		$sql = "SELECT b.branchName,t.id,t.billId,t.name,t.phone,t.billCount,t.releases,t.grossW,t.netW,t.grossA,t.netA,t.amountPaid,t.date,t.time,t.branchId,t.comm,t.margin,t.status 
		FROM trans t,branch b 
		WHERE t.metal='Silver' AND  t.date='$date' AND t.status='Approved' AND t.branchId=b.branchId ".$extra_query." ORDER BY t.id DESC";
		$query=mysqli_query($con,$sql);
	}
	else if($search!=="" && $search1!==""  && $search2!="All Branches"){
		$sql = "SELECT b.branchName,t.id,t.billId,t.name,t.phone,t.billCount,t.releases,t.grossW,t.netW,t.grossA,t.netA,t.amountPaid,t.date,t.time,t.branchId,t.comm,t.margin,t.status 
		FROM trans t,branch b 
		WHERE t.metal='Silver' AND t.status='Approved' AND t.branchId=b.branchId AND t.date BETWEEN '$search1' AND '$search' AND t.branchId='$search2' ".$extra_query." ORDER BY t.id DESC";
		$query = mysqli_query($con,$sql);
	}
	else if($search!=="" && $search1!==""  && $search2=="All Branches"){
		$sql = "SELECT b.branchName,t.id,t.billId,t.name,t.phone,t.billCount,t.releases,t.grossW,t.netW,t.grossA,t.netA,t.amountPaid,t.date,t.time,t.branchId,t.comm,t.margin,t.status FROM trans t,branch b 
		WHERE t.metal='Silver' AND t.status='Approved' AND t.branchId=b.branchId AND t.date BETWEEN '$search1' AND '$search' ".$extra_query." ORDER BY t.id DESC";
		$query = mysqli_query($con,$sql);
	}
?>
<style>
...
<div id="wrapper">
	<div class="row content">
		<div class="col-lg-12">
			...
			<div class="hpanel">
				<fieldset>
					<legend> <i style="padding-top:15px" class="fa_Icon fa fa-eye"></i> SILVER TRANSACTIONS </legend>
