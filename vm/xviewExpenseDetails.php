		...
		<div class="col-lg-12">
			<div class="hpanel">
				<div class="panel-heading">
					<h3 class="text-success"><i class="fa_Icon fa fa-edit"></i> Edit & Verify / Reject Expense </h3>
				</div>
				<div class="panel panel-info">
					<div class="panel-body" style="box-shadow:0px 0px 25px #333">
						<form method="POST" action='xexpVerify.php'>
							...
							<table class="table table-user-information">
								<tbody>
									...
									<tr>
										...
										<td><input type="text" name="amount" class="form-control" value="<?php echo $expData['amount']; ?>"></td>
									</tr>
									<tr>
										<td colspan="3">
										...
										<td style="text-align:center;">
											<button class="btn btn-success" name="submitVerifyExp" style="margin-top:23px;"><span style="color:#ffcf40" class="fa fa-check"></span> VERIFY </button>
											<button class="btn btn-danger" name="submitRejectExp" style="margin-top:23px;"><span style="color:#ffcf40" class="fa fa-times"></span> REJECT </button>
										</td>
									</tr>
								</tbody>
							</table>
