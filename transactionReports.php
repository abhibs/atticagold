<?php
	...
	if($search=="" && $search1==""  && $search2==""){
		$sql = "SELECT t.customerId,t.billId,t.name,t.phone,t.grossW,t.netW,t.grossA,t.netA,t.releases,t.amountPaid,t.date,t.time,b.branchName FROM trans t,branch b WHERE t.date='$date' AND t.status='Approved' AND t.branchId=b.branchId ".$extra_query." ORDER BY t.id DESC";
		$query=mysqli_query($con,$sql);
	}
	else if($search!=="" && $search1!==""  && $search2!="All Branches"){
		$sql = "SELECT t.customerId,t.billId,t.name,t.phone,t.grossW,t.netW,t.grossA,t.netA,t.releases,t.amountPaid,t.date,t.time,b.branchName FROM trans t,branch b WHERE t.status='Approved' AND t.branchId=b.branchId AND t.date BETWEEN '$search1' AND '$search' AND t.branchId='$search2' ".$extra_query." ORDER BY t.id DESC";
		$query = mysqli_query($con,$sql);
	}
	else if($search!=="" && $search1!==""  && $search2=="All Branches"){
		$sql = "SELECT t.customerId,t.billId,t.name,t.phone,t.grossW,t.netW,t.grossA,t.netA,t.releases,t.amountPaid,t.date,t.time,b.branchName FROM trans t,branch b WHERE t.status='Approved' AND t.branchId=b.branchId AND t.date BETWEEN '$search1' AND '$search' ".$extra_query." ORDER BY t.id DESC";
		$query = mysqli_query($con,$sql);
	}
?>
<style>
			...
			<div class="col-lg-12">
				<div class="hpanel">
					<div class="panel-heading">
						<h3 class="text-success"><i style="color:#900" class="fa fa-edit"></i> Transaction Report</h3>
					</div>
